...
const AboutUsCard = ({id, image, title}) =>(
  <div className='flex flex-col items-center justify-center sm:w-[165px] sm:h-[180px] xs:w-[100px] xs:h-[115px] w-[80px] h-[95px] border-[1px] border-darkGreen bg-white gap-[14px]'>
    <img src={image} alt={title} className='sm:max-h-[78px] xs:max-h-[50px] max-h-[40px]' />
...
const AboutUs = () => (
  <section id='AboutUs' className={`flex md:flex-row flex-col bg-lightBlue ${styles.paddingX} ${styles.paddingY} md:gap-[119px] gap-[50px] justify-center items-center`}>
    ...
    <div>
      <img src={facial1} alt="" className='sm:min-h-[546px] sm:min-w-[614px]' />
    </div>
